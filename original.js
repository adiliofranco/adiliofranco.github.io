...
function AlteraRele13(){
  ...
  if(estado_13==="0")
  {
    ...
    document.getElementById("rele_13").innerHTML="<div class='rele3_desligado'></div>";
    document.getElementById("botao_13").innerHTML="<a href='/?3_ligar' class='botao_13'>Liga</a>";
  }
}
...
function AlteraRele16(){
  ...
  if(estado_16==="0")
  {
    ...
    document.getElementById("rele_16").innerHTML="<div class='rele3_desligado'></div>";
