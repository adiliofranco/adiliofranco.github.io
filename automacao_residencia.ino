    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == 'n')
        {
          ...
          client.println("<html>");
          client.println("<head>");
          client.println("<title>Area de Lazer</title>");
          client.println("<meta http-equiv='Content-Type' content='text/html; charset=ISO-8859-1'>");
          client.println("<meta name='viewport' content='width=720, initial-scale=0.5' />");
          client.println("<link rel='stylesheet' type='text/css' href='https://adiliofranco.github.io/automacao_residencial.css' />");// buscar o css
          client.println("<script type='text/javascript' src='https://adiliofranco.github.io/automacao_residencial.js'></script>"); // Buscar o Js
          client.println("</head>");
          client.println("<body>");
          //client.println("<div id='wrapper'><img alt='IMAGEM' src='https://img'/><br/>");
          client.println("<div id='div1'>Rele 1</div>");
          client.println("<div id='div2'>Rele 2</div>");
          client.println("<div id='div1'>Rele 3</div>");
          client.println("<div id='div2'>Rele 4</div>");
